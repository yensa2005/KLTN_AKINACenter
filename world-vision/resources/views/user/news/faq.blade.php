            ...
            <div class="panel-group" id="accordion">
                <div class="panel panel-default my-4">
                    ...
                    <div id="collapseOne" class="panel-collapse collapse in">
                        <div class="panel-body my-4 mx-5">
                            <p> Để gửi bài viết cho Kenh14.vn, bạn vui lòng thực hiện theo các bước sau đây:</p>
                            <p><b>Bước 1:</b> Chuẩn bị thông tin/ bài viết.</p>
                            <p><b>Bước 2:</b> Chọn chuyên mục phù hợp với thông tin/ bài viết để gửi.</p>
                            <ul>
                                <li>Mobile: <span>mobile@worldvision.com</span></li>
                                <li>Concept: <span>concept@worldvision.com</span></li>
                                <li>Ứng dụng: <span>ungdung@worldvision.com</span></li>
                                <li>Thủ thuật: <span>thuthuat@worldvision.com</span></li>
                                <li>Công nghệ vui: <span>congnghevui@worldvision.com</span></li>
                            </ul>
                ...
                <div class="panel panel-default my-4">
                    ...
                    <div id="collapseEleven" class="panel-collapse collapse">
                        <div class="panel-body my-4 mx-5">
                            <p>Nếu thông tin/ bài viết của bạn được duyệt và đăng tải, Kenh14.vn sẽ thanh toán nhuận bút cho
